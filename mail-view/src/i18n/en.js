const en = {
    ...
    customBackgroundTitle: 'Custom Login Background',
    customBackgroundHint: 'JPG, PNG, WebP and GIF are supported, up to 10 MB. 1920 × 1080 or larger is recommended.',
    uploadImage: 'Upload Image',
    replaceImage: 'Replace Image',
    removeImage: 'Remove Image',
    backgroundTypeError: 'Choose a JPG, PNG, WebP or GIF image',
    backgroundSizeError: 'The image must not exceed 10 MB',
    backgroundUploadSuccess: 'Login background uploaded',
    backgroundRemoveSuccess: 'Login background removed',
